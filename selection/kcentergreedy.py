...
class kCenterGreedy(EarlyTrain):
    def __init__(self,network, dst_train, args, fraction=0.5, random_seed=None, device=None, task_id = None, epochs=0,
        ...
        with torch.no_grad():
            with self._model.embedding_recorder:
                ...
                for i, (_, inputs, _) in enumerate(data_loader):
                    ...
                    self._model(inputs)
                    matrix.append(self._model.embedding_recorder.embedding["features"])
